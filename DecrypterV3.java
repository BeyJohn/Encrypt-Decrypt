...
public class DecrypterV3 extends Application 
{
	...
	private static void setup() throws Exception
	{
		...
		Scanner it = new Scanner(decryptedText);
		it.useDelimiter("\n");
	...
	{
		path = new File(DecrypterV3.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath());
